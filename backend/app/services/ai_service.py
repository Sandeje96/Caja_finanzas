...
INTENT_CONFIRM          = 'CONFIRM_TRANSACTION'
INTENT_UPDATE           = 'UPDATE_TRANSACTION'
INTENT_DELETE           = 'DELETE_TRANSACTION'
INTENT_CANCEL           = 'CANCEL_TRANSACTION'
INTENT_QUERY_RECENT     = 'QUERY_RECENT'
INTENT_QUERY_RECEIPT    = 'QUERY_RECEIPT'
INTENT_QUERY            = 'QUERY'
INTENT_HELP             = 'HELP'
